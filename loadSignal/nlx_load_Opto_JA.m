...
function [time, signal, fs, high_cut] = nlx_load_Opto_JA(experiment, CSC, ExtractModeArray, downsampling_factor, save_data)
...
elseif isa(CSC,'char')
    filename = strcat(experiment.path,filesep,experiment.name,'\',CSC,'.ncs');
end
