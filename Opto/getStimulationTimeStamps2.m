%% By Joachim
function [stimulatioTimeStamps] = getStimulationTimeStamps2(experiment, save_data)
%% USE NOT downsampled data!
Path = get_path;
parameters=get_parameters;
%create filename
filename = strcat(experiment.path,filesep, experiment.name,filesep, 'STIM2D.ncs');
